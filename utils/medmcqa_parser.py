...
class medmcqa:
    def __init__(self):
        # load data
        with open("datasets/medmcqa/medmcqa.json", "r") as f:
            self.data = json.load(f)
        
        # s1_prompt
        self.s1_prompt_demonstration = medmcqa_s1_prompt_demonstration
        
        # s2_edit_prompt
        self.s2_edit_prompt_demonstration = medmcqa_s2_edit_prompt_demonstration
    ...
    def get_question(self, data_point):
        ...
        for x in range(len(self.data)):
            if self.data[x]["question"] == data_point["question"]:
                q_id = x
                break
        opa = self.data[q_id]["opa"]
        opb = self.data[q_id]["opb"]
        opc = self.data[q_id]["opc"]
        opd = self.data[q_id]["opd"]
        
        return data_point["question"] + " A: " + opa + " B: " + opb + " C: " + opc + " D: " + opd
    ...
    def get_final_answer(self, model, data_point):
        ...
        print("****** Gold answer:", data_point["cop"])
        return data_point
