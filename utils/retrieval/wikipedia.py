...
def generate_wikipedia_query(input, overall_question):
    ...
    query = call_openai_api("gpt-4", prompt, max_tokens=256, temperature=0, n=1)[1].strip() #change "text-davinci-003" to gpt-4
    query += " @wikipedia"
    return query

def execute_wikipedia_query(query):
    key='074b4045acbfcee51b20864549cb7a492df9d7b1a96c4005803c2d59d9fa2876'
