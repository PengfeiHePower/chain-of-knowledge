...
def generate_ck12_query(input, overall_question):
...
def retrieve_ck12_knowledge(input, data_point):
    print("Generate query...")
    query = generate_ck12_query(input, data_point["question"])
    print(query)
    print("Retrieve knowledge...")
    knowl = execute_ck12_query(query)
    print(knowl)
    return knowl
