...
def generate_physicsclassroom_query(input, overall_question):
...
def execute_physicsclassroom_query(query):
...
def retrieve_physicsclassroom_knowledge(input, data_point):
    print("Generate query...")
    query = generate_physicsclassroom_query(input, data_point["question"])
    print(query)
    print("Retrieve knowledge...")
    knowl = execute_physicsclassroom_query(query)
    print(knowl)
    return knowl
